...
def trainLDADBN(finetune_lr = 0.1, pretraining_epochs = 200, pretrain_lr = 0.01, k = 1,
    ...
    training_file_path = "../../dataset/features/anno1000_feature_2014-11-17"
    RightParameters_file_path = "../../output/rightParameters"
    TopParameters_file_path = "../../output/TopParameters"
    
    (train_set_x,train_set_y,train_x,train_y),(test_set_x,test_set_y,test_x,test_y) = Rdata_load(training_file_path,0,0)  # testset is empty.
