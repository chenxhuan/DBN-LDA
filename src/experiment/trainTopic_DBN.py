...
def trainTdbn(finetune_lr=0.1,pretraining_epochs=200,
    ...
    pretrainingR_fns,Layers = dbn2.pretraining_function(train_set_x=Layers(), batch_size=batch_size, k=k)
    ...
    pretrainingR_fns,Layers = dbn3.pretraining_function(train_set_x=Layers(), batch_size=batch_size, k=k)
