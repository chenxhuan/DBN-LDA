...
__doc__ = 'test for 900 english articles'
__author__ = 'Kangzhi Zhao'

def test_SdA(finetune_lr=0.1, pretraining_epochs=100,
             pretrain_lr=0.1, training_epochs=200,
             dataset='ada_20161210_tfidf', fold_size = 90, topicFile= 'ada_20161210_tfidf',hidden_layers=[594, 594, 594],
             n_ins= 1188, batch_size=20, dataIndex=0,lamda=0.001,
             corruption_levels = [0.05, 0.05, 0.05]):
    """
    ...
    saveFile = file("../../output/result_sda_en.txt", 'a')
