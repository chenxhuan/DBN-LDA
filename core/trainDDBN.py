...
def trainDdbn(finetune_lr=0.1,pretraining_epochs=200,
    ...
    saveFile = file("result.txt",'a')
    (train_set_x,train_set_y,train_x,train_y),(test_set_x,test_set_y,test_x,test_y) = Rdata_load("/home/chenxh/workspace/DBNprocessing/dataset/features/anno1000_feature_2014-11-17",
                                    dataIndex*100,(dataIndex+1)*100)
#                                     100,3936)
    (topic_train, topic_label,topic_x,topic_y) = Ldata_load("/home/chenxh/workspace/DBNprocessing/dataset/features/topicFeature_2014-11-21")
