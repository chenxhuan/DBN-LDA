...
def getTopicName(index):
    ...
    f = open('/home/chenxh/workspace/DBNprocessing/dataset/topics','rb')
    lines = f.readlines()
    return lines[index]

def predictTopic():
    
    test_file_path = "/home/chenxh/workspace/DBNprocessing/dataset/features/anno1000_feature_2014-11-17"
    RightParameters_file_path = "rightParameters"
    TopParameters_file_path = "TopParameters"
    
    (train_set_x,train_set_y,train_x,train_y),(test_set_x,test_set_y,test_x,test_y) = Rdata_load(test_file_path,0,1)
    (topic_train, topic_label,topic_x,topic_y) = Ldata_load("/home/chenxh/workspace/DBNprocessing/dataset/features/lda_0321.fword")
